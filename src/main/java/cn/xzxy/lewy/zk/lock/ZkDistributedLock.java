...
public class ZkDistributedLock implements InitializingBean {
    ...
    public boolean releaseDistributedLock(String path) {
        try {
            String keyPath = "/" + ROOT_PATH_LOCK + "/" + path;
            if (curatorClient.checkExists().forPath(keyPath) != null) {
                curatorClient.delete().forPath(keyPath);
            }
        } catch (Exception e) {
    ...
    private void addWatcher(String path) throws Exception {
        ...
        final PathChildrenCache cache = new PathChildrenCache(curatorClient, keyPath, false);
    ...
    public void afterPropertiesSet() {
        curatorClient = curatorClient.usingNamespace("lock-namespace");
